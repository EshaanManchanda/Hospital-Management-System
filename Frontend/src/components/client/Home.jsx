  ...
  },
  {
    ...
    return (
      <div className="bg-[hsl(var(--background))] min-h-screen">
        <section className="hero bg-[hsl(var(--primary))] text-[hsl(var(--primary-foreground))] py-12 sm:py-20 px-4 rounded-3xl mx-2 sm:mx-4 mt-4">
          <div className="container mx-auto text-center">
            ...
            <Link to="/signup">
              <motion.button
                className="bg-[hsl(var(--accent))] text-white font-bold py-2 px-6 rounded-full hover:bg-[hsl(var(--accent))/80] transition duration-300 shadow-md"
        ...
        <section className="features py-12 sm:py-20">
          <div className="container mx-auto px-4">
            <h2 className="text-2xl sm:text-3xl font-bold text-center mb-8 sm:mb-12 text-[hsl(var(--primary))]">
              Our Features
            </h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
              {features.map((feature, index) => (
                <motion.div
                  key={index}
                  className="bg-[hsl(var(--card))] p-6 rounded-3xl shadow-lg text-center feature-card"
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ duration: 0.5, delay: index * 0.01 }}
                  whileHover={{ y: -10 }}
                >
                  <feature.icon className="text-4xl sm:text-5xl text-[hsl(var(--accent))] mb-4 mx-auto" />
                  <h3 className="text-lg sm:text-xl font-semibold mb-2 text-[hsl(var(--primary))]">
                    {feature.title}
                  </h3>
        ...
        <section className="about-us bg-[hsl(var(--card))] py-20">
          <div className="container mx-auto px-4 flex flex-col md:flex-row items-stretch">
            ...
            <div className="md:w-1/2 md:pl-8 flex flex-col justify-between">
              <h2 className="text-3xl font-bold text-center mb-8 text-[hsl(var(--primary))]">
                About Health Nest
              </h2>
              <div className="flex-grow">
                <p className="text-[hsl(var(--muted-foreground))] mb-4 text-[1.1rem] font-montserrat">
        ...
        <section className="testimonials bg-[hsl(var(--muted))] py-20">
          <div className="container mx-auto px-4">
            ...
            <Slider {...settings}>
              {testimonials.map((testimonial, index) => (
                <motion.div
                  key={index}
                  className="bg-[hsl(var(--card))] p-6 rounded-xl h-55 w-250 mx-2 cursor-pointer transition-all ease-out hover:font-semibold" 
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
                ...
                >
                  ...
                  />
                  <p className="text-[hsl(var(--muted-foreground))] mb-4 text-center text-sm">
                    "{testimonial.text}"
                  </p>
                  <p className="text-[hsl(var(--primary))] font-semibold text-center">
                    - {testimonial.name}
                  </p>
                </motion.div>
              ))}
        ...
        <section className="cta bg-[hsl(var(--primary))] text-[hsl(var(--primary-foreground))] py-20 rounded-3xl mx-4 mb-4">
